# src/mt4_bridge/strategies/strategy_20260403t102021_i01_v1.py
...
def _base_signal(
    ...
    if len(bars) < required_bars():
        raise SignalEngineError(
            f"At least {required_bars()} bars are required to evaluate strategy_20260403t102021_i01_v1"
        )
...
def evaluate_strategy_20260403t102021_i01_v1(
    market_snapshot: MarketSnapshot,
    position_snapshot: PositionSnapshot,
    strategy_name: str = "strategy_20260403t102021_i01_v1",
) -> SignalDecision:
    bars = market_snapshot.bars
    if len(bars) < required_bars():
        raise SignalEngineError(
