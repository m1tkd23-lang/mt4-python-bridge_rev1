...
from mt4_bridge.strategies.bollinger_range_A_guarded import (
...
def evaluate_bollinger_combo_AB_v1_signals(
    market_snapshot: MarketSnapshot,
    position_snapshot: PositionSnapshot,
    strategy_name: str = "bollinger_combo_AB_v1",
) -> list[SignalDecision]:
    ...
    range_decision = _rename_strategy(
        evaluate_bollinger_range_A_guarded(
            ...
            strategy_name="bollinger_range_A_guarded",
        ),
        strategy_name,
    )
...
def evaluate_bollinger_combo_AB_v1(
    market_snapshot: MarketSnapshot,
    position_snapshot: PositionSnapshot,
    strategy_name: str = "bollinger_combo_AB_v1",
) -> SignalDecision:
    return evaluate_bollinger_combo_AB_v1_signals(
        market_snapshot=market_snapshot,
        position_snapshot=position_snapshot,
        strategy_name=strategy_name,
    )[0]