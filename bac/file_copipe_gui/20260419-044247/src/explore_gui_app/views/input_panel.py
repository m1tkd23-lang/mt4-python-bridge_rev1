...
class IntStepper(QWidget):
    ...
    Balanced for terminal-style UI:
    - stable control height
    - narrower button column
    - centered arrow glyphs
    - font size recalculated from current button height
    """
    ...
    def __init__(
        ...
        for button in (self._up_button, self._down_button):
            ...
            button.setStyleSheet("padding: 0; margin: 0; text-align: center;")
    ...
    def _refresh_button_fonts(self) -> None:
        for button in (self._up_button, self._down_button):
            ...
            pixel_size = max(8, min(14, int(height * 0.8)))
