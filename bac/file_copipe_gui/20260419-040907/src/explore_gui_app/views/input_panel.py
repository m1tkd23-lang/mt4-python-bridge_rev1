...
class IntStepper(QWidget):
    """Integer input with explicit custom ▲ / ▼ buttons."""
    ...
    def __init__(
        ...
        self._line_edit.setAlignment(self._line_edit.alignment())
        ...
        self._up_button.setFixedHeight(14)
        self._down_button.setFixedHeight(14)
